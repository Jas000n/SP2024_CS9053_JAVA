...
(
    ...
    constraint Lines_Picture_PID_fk
        foreign key (PID) references draw_guess.Picture (PID)
);
...
(
    ...
    constraint Picture_Player_UID_fk
        foreign key (authorID) references draw_guess.Player (UID)
);
